...
object LinRegWalkthrough extends App {
  ...
  val data = spark.read.option("header","true").option("inferSchema","true").format("csv").load("resources/datasets/USA_Housing_c.csv")
